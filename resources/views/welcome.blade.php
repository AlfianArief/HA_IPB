...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Himpunan Alumni IPB</title>
    ...
    <body>
                 ...
                 @if (Route::has('user.login'))
                    <div class="hidden ms-auto top-0 py-3 sm:block">
                        ...
                        @if (Route::has('user.register'))
                            <a href="{{ route('user.register') }}" class="ml-4 text-light text-xl text-uppercase text-black-700">Register</a>
                        @endif
                    @endauth
                    </div>
                @endif
        ...
        <img src="{{ asset('image/bg1.jpg') }}" class="img" alt="..." style="height: 100%; width: 100%;">
    </body>
</html>
